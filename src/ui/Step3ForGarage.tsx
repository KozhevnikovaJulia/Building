...
type Step3ForGaragePropsType = {
  startOver: () => void;
};

export const Step3ForGarage = (props: Step3ForGaragePropsType) => {
  ...
  return (
    <div>
      <Step title={'Длина стен в метрах'} step={'Шаг 3'} numberOfButtons={2} onClickCancellation={startOver} button2Name={'Расчитать'} onClickNextStep={getResult}>
